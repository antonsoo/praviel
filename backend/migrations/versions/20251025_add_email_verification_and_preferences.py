...
def upgrade() -> None:
    ...
    op.add_column(
        "user_preferences",
        sa.Column("email_streak_reminders", sa.Boolean(), nullable=False, server_default="true"),
    )
    op.add_column(
        "user_preferences",
        sa.Column("email_srs_reminders", sa.Boolean(), nullable=False, server_default="true"),
    )
    op.add_column(
        "user_preferences",
        sa.Column("email_achievement_notifications", sa.Boolean(), nullable=False, server_default="true"),
    )
    op.add_column(
        "user_preferences",
    ...
    op.add_column(
        "user_preferences",
        sa.Column("email_onboarding_series", sa.Boolean(), nullable=False, server_default="true"),
    )
    op.add_column(
        "user_preferences",
        sa.Column("email_new_content_alerts", sa.Boolean(), nullable=False, server_default="false"),
    )
    op.add_column(
        "user_preferences",
        sa.Column("email_social_notifications", sa.Boolean(), nullable=False, server_default="false"),
    )
    op.add_column(
        "user_preferences",
        sa.Column("email_re_engagement", sa.Boolean(), nullable=False, server_default="true"),
    )

    # SRS reminder timing preference (hour of day, 0-23)
    op.add_column(
        "user_preferences", sa.Column("srs_reminder_time", sa.Integer(), nullable=False, server_default="9")
    )

    # Streak reminder timing preference (hour of day, 0-23)
    op.add_column(
        "user_preferences",
        sa.Column("streak_reminder_time", sa.Integer(), nullable=False, server_default="18"),
    )

    # Onboarding tracking
    op.add_column(
        "user_preferences",
        sa.Column("onboarding_day1_sent", sa.Boolean(), nullable=False, server_default="false"),
    )
    op.add_column(
        "user_preferences",
        sa.Column("onboarding_day3_sent", sa.Boolean(), nullable=False, server_default="false"),
    )
    op.add_column(
        "user_preferences",
        sa.Column("onboarding_day7_sent", sa.Boolean(), nullable=False, server_default="false"),
    )

    # Last reminder sent timestamps (to prevent duplicates)
    op.add_column(
        "user_preferences", sa.Column("last_streak_reminder_sent", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "user_preferences", sa.Column("last_srs_reminder_sent", sa.DateTime(timezone=True), nullable=True)
    )
