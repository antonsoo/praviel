...
class Settings(BaseSettings):
    ...
    COACH_ENABLED: bool = Field(default=True)
    ...
    LESSONS_ENABLED: bool = Field(default=True)
    ...
    # Echo Fallback Control (allows app to work without API keys)
    ECHO_FALLBACK_ENABLED: bool = Field(default=True)
    ...
    FRONTEND_URL: str = Field(default="https://app.praviel.com")  # For password reset links and CORS
