...
class UserProfileUpdate(BaseModel):
    ...
    preferred_pronouns: str | None = Field(None, max_length=32)
    gender_identity: str | None = Field(None, max_length=32)
    age_bracket: str | None = Field(None, max_length=16)
...
class UserPreferencesUpdate(BaseModel):
    ...
    primary_language: str | None = Field(None, max_length=20)
    daily_xp_goal: int | None = Field(None, ge=0, le=10000)
    daily_goal_minutes: int | None = Field(None, ge=0, le=720)
    ...
    notification_time: str | None = Field(
        None,
        description="Preferred daily notification time (HH:MM, 24h)",
        pattern=r"^([01]?\d|2[0-3]):[0-5]\d$",
    )
    font_size: float | None = Field(None, ge=0.5, le=2.0)
    show_translations: bool | None = None
    show_grammar_hints: bool | None = None
    tts_voice: str | None = Field(None, max_length=120)
    tts_speed: float | None = Field(None, ge=0.25, le=3.0)
