...
class UserProfile(TimestampMixin, Base):
    ...
    preferred_pronouns: Mapped[str | None] = mapped_column(String(32), default=None)
    gender_identity: Mapped[str | None] = mapped_column(String(32), default=None)
    age_bracket: Mapped[str | None] = mapped_column(String(16), default=None)
    country_code: Mapped[str | None] = mapped_column(String(2), default=None, index=True)
    interests: Mapped[list[str] | None] = mapped_column(JSONB, default=None)
...
class UserPreferences(TimestampMixin, Base):
    ...
    primary_language: Mapped[str | None] = mapped_column(String(20), default=None)
    ...
    notification_time: Mapped[str | None] = mapped_column(String(8), default=None)
    font_size: Mapped[float] = mapped_column(Numeric(4, 2), default=1.0)
    show_translations: Mapped[bool] = mapped_column(Boolean, default=True)
    show_grammar_hints: Mapped[bool] = mapped_column(Boolean, default=True)
    tts_voice: Mapped[str | None] = mapped_column(String(120), default=None)
    tts_speed: Mapped[float] = mapped_column(Numeric(4, 2), default=1.0)
    ...
    persona_preferences: Mapped[dict | None] = mapped_column(JSONB, default=None)
