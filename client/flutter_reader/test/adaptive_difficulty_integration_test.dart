...
import 'package:praviel/services/adaptive_difficulty_service.dart';
...
void main() {
  ...
  group('Adaptive Difficulty Integration Tests', () {
    ...
    test('Records performance and adapts difficulty downward', () async {
      ...
      expect(service.currentDifficulty, lessThanOrEqualTo(0.35));
    ...
    test('Provides insights after sufficient data', () async {
      ...
      expect(insights.totalExercises, greaterThanOrEqualTo(10));
      expect(insights.totalExercises, lessThanOrEqualTo(20));
