...
class _FriendsPageState extends ConsumerState<FriendsPage>
  ...
  Widget _buildGuestCard(ThemeData theme, ColorScheme colorScheme) {
    return GlassContainer(
      ...
      child: Column(
        ...
        children: [
          Icon(Icons.people_outline, color: colorScheme.primary, size: 48),
          ...
          Text(
            'Create an account to add friends, accept requests, and cheer each other on.',
              ...
              SliverPadding(
                ...
                sliver: SliverToBoxAdapter(
                  child: !isAuthenticated
                      ? _buildGuestCard(theme, colorScheme)
                      : _isLoading
                      ? _buildLoading()
                      : _error != null
