      ...
      child: Padding(
        ...
        child: GlassContainer(
          ...
          child: Column(
            ...
            children: [
              Icon(Icons.lock_outline, color: colorScheme.primary, size: 48),
              ...
              Text(
                'Sign in to earn streaks, compete with friends, and unlock double-or-nothing rewards.',
            ...
            slivers: [
              ...
              SliverPadding(
                ...
                sliver: !isAuthenticated
                    ...
                    : _isLoading && _challenges.isEmpty
                    ? _buildLoadingSliver()
                    : _error != null
