...
const List<LessonModelPreset> kLessonModelPresets = <LessonModelPreset>[
  ...
  LessonModelPreset(id: 'claude-sonnet-4-5', label: 'Claude Sonnet 4.5', provider: 'anthropic'),
  LessonModelPreset(id: 'claude-opus-4-1-20250805', label: 'Claude Opus 4.1', provider: 'anthropic'),
  LessonModelPreset(id: 'claude-sonnet-4', label: 'Claude Sonnet 4', provider: 'anthropic'),
  LessonModelPreset(id: 'claude-opus-4', label: 'Claude Opus 4', provider: 'anthropic'),
  // OpenAI GPT-5 models
  ...
  LessonModelPreset(id: 'gemini-2.5-flash', label: 'Gemini 2.5 Flash', provider: 'google'),
  LessonModelPreset(id: 'gemini-2.5-flash-lite', label: 'Gemini 2.5 Flash-Lite', provider: 'google'),
  LessonModelPreset(id: 'gemini-2.5-flash-preview-09-2025', label: 'Gemini 2.5 Flash Preview', provider: 'google'),
];
