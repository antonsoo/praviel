...
class GeneratorParams {
  ...
  Map<String, dynamic> toJson({
    ...
    'use_demo_key': overrideUseDemoKey ?? useDemoKey,
  };
}
...
class LessonApi {
  ...
  Future<LessonResponse> _generateInternal(
    ...
    final useDemoKey =
        (params.useDemoKey || settings.useDemoLessonKey) && provider != 'echo';
