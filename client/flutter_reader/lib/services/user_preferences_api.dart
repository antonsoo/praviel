...
class UserPreferencesApi {
  ...
  Future<UserPreferences> updatePreferences({
    ...
    String? ttsVoice,
    double? ttsSpeed,
    Map<String, dynamic>? personaPreferences,
  }) async {
    return _retryRequest(() async {
      final uri = Uri.parse('$baseUrl/api/v1/users/me/preferences');
      ...
      final body = <String, dynamic>{
        ...
        if (personaPreferences != null && personaPreferences.isNotEmpty)
...
class UserPreferences {
  ...
  // Persona & chat personalization
  final Map<String, dynamic>? personaPreferences;
  ...
  factory UserPreferences.fromJson(Map<String, dynamic> json) {
    return UserPreferences(
      ...
      personaPreferences: json['persona_preferences'] as Map<String, dynamic>?,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'tts_voice': ttsVoice,
      'tts_speed': ttsSpeed,
      if (personaPreferences != null) 'persona_preferences': personaPreferences,
    };
  }
  ...
  UserPreferences copyWith({
    ...
    return UserPreferences(
      ...
      personaPreferences: personaPreferences ?? this.personaPreferences,
    );
  }
