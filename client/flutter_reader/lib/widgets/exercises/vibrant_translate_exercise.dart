...
class VibrantTranslateExercise extends StatefulWidget {
  ...
  @override
  State<VibrantTranslateExercise> createState() => _VibrantTranslateExerciseState();
}
...
class _VibrantTranslateExerciseState extends State<VibrantTranslateExercise> {
  ...
  LessonCheckFeedback _check() {
    ...
    final expected = (widget.task.sampleSolution ?? widget.task.rubric).toLowerCase();
          ...
          if (!_checked)
            SlideInFromBottom(
              ...
              child: TextButton.icon(
                ...
                icon: Icon(
                  _showHints ? Icons.lightbulb_rounded : Icons.lightbulb_outline_rounded,
                ),
