...
/// True/False exercise with interactive buttons
class VibrantTrueFalseExercise extends StatefulWidget {
  const VibrantTrueFalseExercise({
    super.key,
    required this.task,
  ...
  @override
  State<VibrantTrueFalseExercise> createState() =>
      _VibrantTrueFalseExerciseState();
}

class _VibrantTrueFalseExerciseState extends State<VibrantTrueFalseExercise> {
  ...
  @override
  void didUpdateWidget(covariant VibrantTrueFalseExercise oldWidget) {
  ...
  LessonCheckFeedback _check() {
    ...
    final correct = _selectedAnswer == widget.task.isTrue;
    ...
    return LessonCheckFeedback(
      ...
      message: correct
          ? 'Correct!'
          : 'Incorrect. The statement is ${widget.task.isTrue ? "TRUE" : "FALSE"}.',
    );
  }
              ...
              if (_checked && _correct != null) ...[
                ...
                ScaleIn(
                  child: InlineFeedback(
                    ...
                    message: _correct!
                        ? 'Correct!'
                        : 'The statement is ${widget.task.isTrue ? "TRUE" : "FALSE"}',
                  ),
                ),
