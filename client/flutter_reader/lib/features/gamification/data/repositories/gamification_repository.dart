  ...
  List<Achievement> _generateMockAchievements() {
    return [
      Achievement(
        ...
        unlockCriteria: const {'lessons_completed': 1},
      ...
      Achievement(
        ...
        unlockCriteria: const {'streak_days': 7},
      ...
      Achievement(
        ...
        unlockCriteria: const {'words_learned': 50},
      ...
      Achievement(
        ...
        unlockCriteria: const {'streak_days': 30},
      ),
      Achievement(
        id: 'polyglot',
        title: 'Polyglot',
        ...
        unlockCriteria: const {'languages_count': 3},
      ),
      Achievement(
        id: 'ancient_sage',
        title: 'Ancient Sage',
        ...
        unlockCriteria: const {'xp_total': 100000},
      ),
    ];
  }
